        ...
        this.$http({
          ...
          if (data.data != null && data.data.length !== 0) {
            for (let i = 0; i < data.data.length; i++) {
              let attrArray = []
              if (data.data[i].attrs !== null && data.data[i].attrs !== 0) {
                for (let j = 0; j < data.data[i].attrs.length; j++) {
                  attrArray.push({
                    attrId: data.data[i].attrs[j].attrId,
                    attrValues: '',
                    showDesc: data.data[i].attrs[j].showDesc
                  })
                }
              }
